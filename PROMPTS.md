...
# 12 - GET /api/users
Implementa GET /api/users utilizando la misma estructura que ya has implementado para el POST asegurandote que los tests del GET /api/users pasan correctamente. Limitate a implementar lo necesario para el GET /api/users, no hagas mas.